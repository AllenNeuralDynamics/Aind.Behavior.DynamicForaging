...
class UncoupledTrialGeneratorSpec(BaseTrialGeneratorSpecModel):
...
class UncoupledTrialGenerator(ITrialGenerator):
    ...
    def update(self, outcome: TrialOutcome) -> None:
        ...
        self.logger.info(f"Updating uncoupled trial generator with trial outcome of {outcome}")
    ...
    def generate_next_block(
        ...
        """
        Generate the next block for an uncoupled task.
