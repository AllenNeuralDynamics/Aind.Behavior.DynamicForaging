...
STAGES = Literal["stage_1_warmup", "stage_1", "stage_2", "stage_3", "stage_4", "final", "graduated"]
...
class FiberPhotometry(BaseModel):
    ...
    stage_start: STAGES = Field(default="stage_1_warmup", description="Stage to start FIP")