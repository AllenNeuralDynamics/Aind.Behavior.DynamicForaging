...
from aind_behavior_dynamic_foraging.CurriculumManager.curriculums.uncoupled_no_baiting_rd_2p3p1 import (
    construct_uncoupled_no_baiting_rd_2p3p1_curriculum,
